// Enable FP64 part of <specialization_constants_override.cpp>.
// To be removed once DPC++ supports optional device features
// and the code could be enabled unconditionally without causing failures
// in speculative compilation of the kernels.
//
