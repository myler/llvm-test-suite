...
<<<<<<<< HEAD:SYCL/Matrix/Legacy/joint_matrix_query_default.cpp
...
>>>>>>>> cbbfcc6c1 ([SYCL] Add matrix tests that use the new API (unified API) (#1391)):SYCL/Matrix/joint_matrix_query_use_default.cpp
